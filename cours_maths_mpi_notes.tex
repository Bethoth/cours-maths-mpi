...
\newcommand{\isomorphisme}[5]{\begin{array}[t]{cccc}#1 : & #2 & \xrightarrow{\;\sim\;} & #3 \\ & #4 & \mapsto & #5\end{array}}
\newcommand{\isomorphismelambda}[4]{\begin{array}[t]{ccc}#1 & \xrightarrow{\;\sim\;} & #2 \\ #3 & \mapsto & #4\end{array}}

\newcommand{\isomorphismeavecreciproque}[7]{\begin{array}[t]{cccc}#1 : & #2 & \xrightarrow{\;\sim\;} & #3 \\ & #4 & \mapsto & #5 \\ & #6 & \mapsfrom & #7\end{array}}
\newcommand{\isomorphismelambdaavecreciproque}[6]{\begin{array}[t]{ccc}#1 & \xrightarrow{\;\sim\;} & #2 \\ #3 & \mapsto & #4 \\ #5 & \mapsfrom & #6\end{array}}
...
\newcommand{\Cf}{\textit{Cf.} }
\newcommand{\sqce}{système quasi-complet d'événements }
\newcommand{\sce}{système complet d'événements }
...
\DeclareDocumentCommand{\symneg}{m O{\K}}{\mathscr{S}^-_{#1}\paren{#2}}
\DeclareDocumentCommand{\symdefneg}{m O{\K}}{\mathscr{S}^{--}_{#1}\paren{#2}}
\DeclareDocumentCommand{\GL}{m O{\K}}{\operatorname{GL}_{#1}\paren{#2}}
\DeclareDocumentCommand{\SL}{m O{\K}}{\operatorname{SL}_{#1}\paren{#2}}
\DeclareDocumentCommand{\SO}{m O{\K}}{\mathscr{SO}_{#1}\paren{#2}}
...
\DeclareDocumentCommand{\fonctionsbornees}{O{\intervii{a}{b}} O{\K}}{\operatorname{\fami{B}}\paren{#1,#2}}
\DeclareDocumentCommand{\fonctionspolynomes}{O{\intervii{a}{b}} O{\K}}{\operatorname{\fami{P}}\paren{#1,#2}}
...
\DeclareDocumentCommand{\detb}{O{\fami{B}}}{\operatorname*{det}_{#1}}
...
\DeclareDocumentCommand{\bouleo}{O{} m m}{B_{#1}\paren{#2,#3}}
\DeclareDocumentCommand{\boulef}{O{} m m}{\conj{B_{#1}}\paren{#2,#3}}
\DeclareDocumentCommand{\sphere}{O{} m m}{S_{#1}\paren{#2,#3}}
\DeclareDocumentCommand{\disqueo}{O{} m m}{D_{#1}\paren{#2,#3}}
\DeclareDocumentCommand{\disquef}{O{} m m}{\conj{D_{#1}}\paren{#2,#3}}

\newcommand{\vdv}[2]{\operatorname{D}_{#1}#2}
\newcommand{\jacobienne}[1]{\operatorname{J}#1}
\newcommand{\hessienne}[1]{\operatorname{H}_{#1}}
\newcommand{\formehessienne}[1]{\operatorname{h}_{#1}}
\newcommand{\espacetangent}[2]{\operatorname{T}_{#1}\paren{#2}}
...
\newcommand{\neg@arrow}{%
  $\m@th\vcenter{\hbox{%
    \rotatebox[origin=c]{-45}{\scalebox{1.5}[1]{$\m@th\scriptstyle|$}}%
  }}$
}
\makeatother

\newcommand{\tendqd}[1]{\xrightarrow[#1]{}}
\newcommand{\ntendqd}[1]{\xnrightarrow[#1]{}}
...
\newcommand{\loigeometrique}[1]{\mathscr{G}\paren{#1}}
\newcommand{\loipoisson}[1]{\mathscr{P}\paren{#1}}

\newcommand{\esp}[1]{\operatorname{\mathbb{E}}\paren{#1}}
\newcommand{\vari}[1]{\operatorname{\mathbb{V}}\paren{#1}}
\newcommand{\cov}[2]{\operatorname{Cov}\paren{#1,#2}}
\newcommand{\ecarttype}[1]{\sigma\paren{#1}}
\newcommand{\coeffcorr}[2]{\operatorname{\rho}\paren{#1,#2}}
...
\newcommand{\ps}[2]{\left\langle\ifblank{#1}{\:\cdot\:}{#1}\tq\ifblank{#1}{\:\cdot\:}{#2}\right\rangle}

\newcommand{\tpt}{\text{pour tout }}
\newcommand{\Tpt}{\text{Pour tout }}

\DeclareDocumentCommand{\Ann}{O{} m}{\operatorname{Ann}_{#1}\paren{#2}}
...
\newcommand{\sgeng}[1]{\langle #1\rangle}

\newcommand{\znz}[1]{\Z/#1\Z}

\newcommand{\field}[1]{\mathbb{F}_{#1}}

\newcommand{\normes}[1]{\fami{N}\paren{#1}}
...
\include{cours/chap1_evn/chap1_evn_notes.tex}

\include{cours/chap2_series_numeriques_vectorielles/chap2_series_numeriques_vectorielles_notes.tex}

\include{cours/chap3_familles_sommables/chap3_familles_sommables_notes.tex}

\include{cours/chap4_algebre_lineaire/chap4_algebre_lineaire_notes.tex}

\include{cours/chap5_reduction_endomorphismes/chap5_reduction_endomorphismes_notes}

\include{cours/chap6_integrales_generalisees/chap6_integrales_generalisees_notes}

\include{cours/chap7_integrales_parametre/chap7_integrales_parametre_notes}

\include{cours/chap8_espaces_prehilbertiens_reels/chap8_espaces_prehilbertiens_reels_notes}

\include{cours/chap9_endomorphismes_espace_euclidien/chap9_endomorphismes_espace_euclidien_notes}

\include{cours/chap10_fonctions_vectorielles/chap10_fonctions_vectorielles_notes}

\include{cours/chap11_suites_series_fonctions/chap11_suites_series_fonctions_notes}

\include{cours/chap12_series_entieres/chap12_series_entieres_notes}

\include{cours/chap13_probabilites/chap13_probabilites_notes}

\include{cours/chap14_variables_aleatoires_discretes/chap14_variables_aleatoires_discretes_notes}

\include{cours/chap15_equations_differentielles_lineaires/chap15_equations_differentielles_lineaires_notes}

\include{cours/chap16_calcul_differentiel/chap16_calcul_differentiel_notes}

\include{cours/chap17_structures_algebriques/chap17_structures_algebriques_notes}

\part{Exercices}

\setcounter{chapter}{0}

\include{exercices/chap1_evn/chap1_evn_notes.tex}

\include{exercices/chap2_series_vectorielles/chap2_series_vectorielles_notes.tex}

\include{exercices/chap3_familles_sommables/chap3_familles_sommables_notes.tex}

\include{exercices/chap4_algebre_lineaire/chap4_algebre_lineaire_notes.tex}

\include{exercices/chap5_reduction_endomorphismes/chap5_reduction_endomorphismes_notes}

\include{exercices/chap6_integrales_generalisees/chap6_integrales_generalisees_notes}

\include{exercices/chap7_integrales_parametre/chap7_integrales_parametre_notes}

\include{exercices/chap8_espaces_prehilbertiens_reels/chap8_espaces_prehilbertiens_reels_notes}

\include{exercices/chap9_endomorphismes_espace_euclidien/chap9_endomorphismes_espace_euclidien_notes}

\include{exercices/chap10_fonctions_vectorielles/chap10_fonctions_vectorielles_notes}

\include{exercices/chap11_suites_series_fonctions/chap11_suites_series_fonctions_notes}

\include{exercices/chap12_series_entieres/chap12_series_entieres_notes}

\include{exercices/chap13_probabilites/chap13_probabilites_notes}

\include{exercices/chap14_variables_aleatoires_discretes/chap14_variables_aleatoires_discretes_notes}

\include{exercices/chap15_equations_differentielles_lineaires/chap15_equations_differentielles_lineaires_notes}

\include{exercices/chap16_calcul_differentiel/chap16_calcul_differentiel_notes}

\include{exercices/chap17_structures_algebriques/chap17_structures_algebriques_notes}
\end{document}